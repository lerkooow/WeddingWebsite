    ...
    <div className={s.modal} onClick={closeContactsModal}>
      <div className={s.modal__content} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: "12px", flexDirection: "column" }}>
          ...
          <Link href="https://wa.me/79870951395" target="_blank" className={s.modal__button}>
            WhatsApp
          </Link>
          <Link href="https://t.me/anastasiyaa_nosova" target="_blank" className={s.modal__button}>
            Telegram
          </Link>
        </div>
      </div>
